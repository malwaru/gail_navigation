...
class KrisEnvTuple(gym.Env,Node):
    ...
    def _get_obs(self):
        ...
        '''
        self.get_logger().info("[debug] 7: get obs")
        ...
        self.get_logger().info("[debug] 8 : get obs feautes")
    ...
    def _take_action(self,pose):
        self.get_logger().info("[debug] 9: _take action")
    ...
    def do_action(self,action):
        ...
        '''
        # self.get_logger().info("[debug] 10 : do action")
        ...
        self.get_logger().info("[debug] 11: do action ")
        ...
        self.get_logger().info("[debug] 12: do action , action done")
    ...
    def reset(self, seed=None, options=None):
        ...
        super().reset()
        self.get_logger().info("[debug] 13: reset before wolrl")

        # self.gazebo.reset_world()

        new_obs = self._get_obs()
        self.get_logger().info("[debug] 14: reset after world")
    ...
    def step(self, action) :
        ...
        '''
        self.get_logger().info("[debug] 15: step ")

        rclpy.spin_once(self)
        done=self.do_action(action)
        self.get_logger().info("[debug] 16: step after do action")

        observation = self._get_obs()
        self.get_logger().info("[debug] 17 : step after get obs")
    ...
    def close(self):
        ...
        '''
        self.get_logger().info("[debug] 19: close senf")
