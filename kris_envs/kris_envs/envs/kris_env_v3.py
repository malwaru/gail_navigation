...
class KrisEnvDepth(gym.Env,Node):
    def __init__(self):
        super(KrisEnvDepth,self).__init__('kris_env_node')
        ...
        self.observation_space = spaces.Box(low=-np.inf, high=np.inf, shape=(238,318), dtype=np.float32)
    ...
    def _get_obs(self):
        ...
        return depth_features.detach().cpu().numpy()
