...
class BagReaderNode(Node):
    def __init__(self):
        ...
        self.traj_end_cmd_sub = self.create_subscription(
            Bool, '/traj_end_cmd', self.traj_end_callback, 10)
    ...
    def traj_end_callback(self, msg):
        '''
        ...
        ros2 topic pub /traj_end_cmd std_msgs/msg/Bool "{data:{}}"
